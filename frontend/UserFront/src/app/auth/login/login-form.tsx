...
export default function LoginForm() {
    ...
    const demoUsers = isProd ? [] : [
        { email: 'instructor@cloudmaster.com', password: 'instructor123', role: 'instructor', name: 'Dr. Marcus' },
        { email: 'student@cloudmaster.com', password: 'student123', role: 'student', name: 'Tarek Student' },
    ];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect based on role or redirectParam
            if (redirectPath) {
