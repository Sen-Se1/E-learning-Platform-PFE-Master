                        ...
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="flex items-center gap-2 sm:gap-3 p-1 h-auto hover:bg-accent/50 rounded-xl transition-all group">
                                <Avatar className="h-9 w-9 border-2 border-primary/10 transition-all group-hover:border-primary/30">
                                    ...
                                    <AvatarFallback className="bg-primary/5 text-primary font-bold text-xs">{userInitials}</AvatarFallback>
                                </Avatar>
                                <div className="text-left hidden sm:block pr-2">
                                    <p className="text-sm font-bold leading-none mb-1">{user?.name || "Guest User"}</p>
                                    <p className="text-[10px] text-muted-foreground font-black uppercase tracking-tight">{role}</p>
                                </div>
