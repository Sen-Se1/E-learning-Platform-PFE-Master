...
const navItems = {
    admin: [
        ...
        { label: "Cloud Infrastructure", href: "/admin/infrastructure", icon: "cloud_done" },
        { label: "Course Metrics", href: "/admin/metrics", icon: "bar_chart_4_bars" },
        { label: "Settings", href: "/admin/settings", icon: "settings" },
    ],
}

function SidebarContent({ role, onClose }: { role: "admin"; onClose?: () => void }) {
    ...
    return (
        <div className="p-6 flex flex-col gap-6 h-full justify-between">
            <div className="flex flex-col gap-8">
                ...
                <nav className="flex flex-col gap-1">
                    {items.map((item) => (
                        ...
                        >
                            <span className={cn("material-symbols-outlined", pathname === item.href && "fill-1")}>
                                {item.icon}
                            </span>
            ...
            <div className="flex flex-col gap-4">
                <div className="p-4 bg-background-light dark:bg-slate-800/50 rounded-xl border border-border">
                ...
                <Button variant="default" className="w-full font-bold text-sm h-11">
